...
public class GDXTextFieldStyle extends TextField.TextFieldStyle {
    ...
    /**
     * Creates a new GDXTextFieldStyle instance with default settings.
     *
     * @return A new GDXTextFieldStyle instance with default style properties.
     */
    public static GDXTextFieldStyle defaults() {
        return new GDXTextFieldStyle();
    }
