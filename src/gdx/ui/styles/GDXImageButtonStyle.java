...
public class GDXImageButtonStyle extends ImageButton.ImageButtonStyle {
    ...
    /**
     * Creates a new GDXImageButtonStyle instance with default settings.
     *
     * @return A new GDXImageButtonStyle instance with default drawable settings.
     */
    public static GDXImageButtonStyle defaults() {
        return new GDXImageButtonStyle();
    }
