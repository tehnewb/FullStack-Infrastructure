...
public class GDXSliderStyle extends Slider.SliderStyle {
    ...
    /**
     * Creates a new GDXSliderStyle instance with default settings.
     *
     * @return A new GDXSliderStyle instance with default style properties.
     */
    public static GDXSliderStyle defaults() {
        return new GDXSliderStyle();
    }
