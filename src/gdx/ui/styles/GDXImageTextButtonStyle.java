...
public class GDXImageTextButtonStyle extends ImageTextButton.ImageTextButtonStyle {
    ...
    /**
     * Creates a new GDXImageTextButtonStyle instance with default settings.
     *
     * @return A new GDXImageTextButtonStyle instance with default drawable settings.
     */
    public static GDXImageTextButtonStyle defaults() {
        return new GDXImageTextButtonStyle();
    }
