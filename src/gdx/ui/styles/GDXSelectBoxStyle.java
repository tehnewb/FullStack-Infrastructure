...
public class GDXSelectBoxStyle extends SelectBox.SelectBoxStyle {
    ...
    /**
     * Creates a new GDXSelectBoxStyle instance with default settings.
     *
     * @return A new GDXSelectBoxStyle instance with default style properties.
     */
    public static GDXSelectBoxStyle defaults() {
        return new GDXSelectBoxStyle();
    }
