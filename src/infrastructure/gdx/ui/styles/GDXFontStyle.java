...
public class GDXFontStyle extends FreeTypeFontParameter {
     ...
     *
     * @param fontName The name of the font style.
     */
    ...
    /**
     * Creates a new GDXFontStyle instance with the specified font name.
     *
     * @param fontName The name of the font style.
     * @return A new GDXFontStyle instance.
     */
    public static GDXFontStyle of(String fontName) {
