...
import infrastructure.event.EventObserver;
import infrastructure.gdx.proto.events.UIClickEvent;
import infrastructure.gdx.proto.events.UIDragEvent;
import infrastructure.gdx.proto.events.UIMouseMoveEvent;
import infrastructure.util.Value;
...
public class UIContainer extends UIActor {
    ...
    public UIActor getActorAt(float x, float y) {
        ...
        for (int i = cells.size() - 1; i >= 0; i--) {
            UIActor actor = cells.get(i).getActor();
