    ...
    CompressionStrategy GZIP = new CompressionStrategy() {
        ...
        public byte[] compress(byte[] data) {
            try (var compressed = new ByteArrayOutputStream()) {
                ...
                throw new CompressionException("Failed to compress using GZip algorithm", e);
            }
        }
        ...
        public byte[] decompress(byte[] data) {
            try (var decompressed = new ByteArrayOutputStream()) {
                ...
                throw new CompressionException("Failed to decompress using GZip algorithm", e);
            }
        }
    };
    ...
    CompressionStrategy Deflate = new CompressionStrategy() {
        ...
        public byte[] compress(byte[] data) {
            ...
            try (var compressed = new DynamicByteBuffer(data.length / 2)) { // we will assume compression to be 50%
                ...
                throw new CompressionException("Failed to compress using Deflate algorithm", e);
            }
        }
        ...
        public byte[] decompress(byte[] data) {
            ...
            try (var decompressed = new DynamicByteBuffer(data.length * 2)) { // we will assume decompression to be 200%
                ...
                throw new CompressionException("Failed to decompress using Deflate algorithm", e);
            }
        }
    };
