...
public class DatabaseClientDecoder extends ByteToMessageDecoder {

    private static final DecoderService[] services = DecoderService.loadServices("database.decoders.client.services");
